...
<form className='flex gap-6 flex-col mt-5' onSubmit={handleCommentSubmission}>
      <div>
        <input type="text" 
      ...
      {error && <div className='fixed bottom-5 w-full right-0 z-10'>
        <p className='text-red-500 bg-red-100 p-8 rounded-md mx-5'>Veuillez remplir tous les champs</p>
      </div>
      }

      <div>
        <button type='submit'
         disabled={loading} className="disabled:opacity-50 border items-center gap-3 border-black px-8 py-4 rounded-full text-center relative overflow-hidden mt-3 flex">
