...
const ContactForm = () => {
  ...
  return (
    ...
    <form action="" method="" onSubmit={(e) => handleSubmit(e)} className='form px-10'>
        ...
        {loading ? 
         <svg aria-hidden="true" className="ml-3 inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-black" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
