      ...
      <div className="bloc flex flex-col gap-5  px-10 py-5 mx-auto h-full justify-between">
        ...
        <div>
          ...
          <div className='flex gap-5'>
            <div className='test'>
          <a className="relative w-fit block after:block after:content-[''] after:absolute after:h-[1px] after:rounded-full after:bg-white after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-left" href="https://www.linkedin.com/in/guillaume-bielli/" alt="Logo Linkedin">Linkedin</a>
            </div>
