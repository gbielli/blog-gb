  ...
  return (
      <section className="home_container bg-secondary">
        ...
        <div className='home_data col-span-4 self-center'>
            <h1 className='text-5xl font-abril'>Hé, c'est Guillaume</h1>
            <h3 className='text-lg font-mulish'>Growth Hacker</h3>
